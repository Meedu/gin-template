...
import (
	...
	"github.com/Meedu/gin-template/constants"
	"github.com/Meedu/gin-template/global"
	_ "github.com/Meedu/gin-template/packfile"
...
func Viper(path ...string) *viper.Viper {
	...
	global.BlackCache = local_cache.NewCache(
		local_cache.SetDefaultExpire(time.Second * time.Duration(global.MD_CONFIG.JWT.ExpiresTime)),
	)
	return v
}
